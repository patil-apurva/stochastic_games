function S_tau_all = simulateMC(eps_t_all_1, eps_t_all_2, zt_prime_1, zt_prime_2, f_zt_prime_1, f_zt_prime_2, t, h, T, b, s, r, eta, d)
    ...
    for t_prime = t:h:T-h % this loop is to compute S(tau_i)
        ...
        zt_prime_1 = zt_prime_1 + f_zt_prime_1*h + s*eps_t_prime_1*sqrt(h); %move tau ahead
        zt_prime_2 = zt_prime_2 + f_zt_prime_2*h + s*eps_t_prime_2*sqrt(h); %move tau ahead
        ...
        f_zt_prime_1 = 0; %f_zt_prime_1 at new t_prime. Will be used in the next iteration 
        f_zt_prime_2 = 0; %f_zt_prime_2 at new t_prime. Will be used in the next iteration 
    end
